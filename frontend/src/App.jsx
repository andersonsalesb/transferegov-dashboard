...
import { 
  ...
  Building2, SlidersHorizontal, TableProperties, LineChart as LineIcon
} from 'lucide-react';
...
export default function App() {
  ...
  async function fetchDashboardData() {
    ...
    try {
      ...
      // Buscar sumários e filtros em paralelo
      ...
      if (summaryRes.ok && chartsRes.ok && dataRes.ok && filtersRes.ok) {
        ...
        // Verifica se há dados gravados no banco
  ...
  return (
    <div className="app-container">
      ...
      <aside className="sidebar">
        ...
        {/* Seção Sincronização */}
        <div className="sidebar-section">
          <div className="sidebar-section-title">Base de Dados</div>
          <div className="form-group">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <section className="charts-grid">
              {/* Gráfico 1: Situação da Análise (Pie) */}
